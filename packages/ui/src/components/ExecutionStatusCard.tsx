...
export interface ExecutionStatusCardProps {
  className?: string;
  activeStep?: 0 | 1 | 2 | 3 | 4; // 0 = idle, 1 = encryption, 2 = enclave, 3 = signing, 4 = success
  strategyName?: string;
          ...
          <CardContent className="flex flex-col gap-5">
            ...
            {onStartExecution && (
              ...
              >
                ...
                {activeStep === 4 ? 'Trigger Another Rebalance' : 'Start Secure Execution Pipeline'}
              </Button>
            )}
          </CardContent>
        </Card>
            ...
            {activeStep === 4 && (
              <div className="flex flex-col gap-3 bg-emerald-950/20 border border-emerald-900/30 rounded-lg p-4 mt-2">
                ...
                <div className="font-mono text-[9px] text-slate-400 flex flex-col gap-1 bg-[#05060a] p-2.5 rounded border border-slate-900 leading-relaxed">
                  ...
                  <span className="truncate">Sign: MIIBIjANBgkqhkiG9w0BAQEFAA...</span>
